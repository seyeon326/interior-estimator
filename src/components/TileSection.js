  ...
  return (
    <div className="bg-white rounded-2xl p-8 mb-8 shadow-xl">
      ...
      <div className="mb-0 p-5 bg-gray-100 rounded-xl">
        <h3 className="text-xl text-gray-700 mb-5 font-semibold">주요 자재</h3>
        ...
        <div className="bg-white p-5 rounded-lg my-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-5">
            ...
            >
              저가형
              <span className="text-sm font-medium opacity-90">50,000원</span>
            </button>
            <button
              className={`px-5 py-4 border-2 rounded-lg cursor-pointer transition-all duration-300 flex flex-col gap-2 font-semibold ${
            ...
            >
              고가형
              <span className="text-sm font-medium opacity-90">100,000원</span>
            </button>
          </div>
